...
getwd()
list.files("~/Downloads/", full.names=FALSE)
```
```{r 2, echo = FALSE, out.width="300px"}
knitr::include_graphics(path = "decisionTree.png")
```
...
``` {r regret table, echo = FALSE}
library(knitr)
df <- data.frame("Favorable market"=c(0,150,250,0.333),"Unfavorable market"=c(80,20,0,0.667),row.names = c("Major renovation","Minor renovation","Do nothing","Probability"))
kable(df,align='c')
```
...
df1 <- data.frame("Favorable market"=c(250,100,0),"Unfavorable market"=c(-80,-20,0),"Expected Profits"=c("0.333(250) + 0.667(-80) = 30","0.333(100) + 0.667(-20) = 20","0.333(0) + 0.667(0) = 0"),row.names = c("Major renovation","Minor renovation","Do nothing"))
kable(df1,align='c')
```
...
``` {r Perfect table, echo = FALSE}
df1 <- data.frame("Favorable market"=c(250,100,0,0.333),"Unfavorable market"=c(-80,-20,0,0.667),row.names = c("Major renovation","Minor renovation","Do nothing","Prob. of Favorability"))
kable(df1,align='c')
```
